...
class Footer {
    constructor(author, prePath) {
        ...
        this._created = '2024-03-19T17:43:49+0900'
    ...
    #project() { return a(this.#externalLinkAttr(({href:`https://github.com/${this._author}/PixcelArtText/`})), img({class:'icon', src:`${this._prePath}asset/image/logo/github/black.svg`})) }
