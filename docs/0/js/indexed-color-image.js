...
//        this._pixcels = []
    ...
    get canvas() { return this._cvs.element }
    get imageData() { return this._cvs.imageData }
    get colors() { return this._colors }
    get pixcels() { return this._pixcels }
    dot(x, y, i) { this._cvs.dot(x, y, ...this._colors[i]) }
    make() {
        console.log(this._cvs.imageData.width)
        for (let x=0; x<this._cvs.imageData.width; x++) {
            for (let y=0; y<this._cvs.imageData.height; y++) {
                this.dot(x, y, this._pixcels[x][y])
...
//                this._cvs.dot(x, y, ...c)
        ...
        console.log(this._cvs.imageData)
        this._cvs.put();
    }
}
/*
